...
import { parsePolishAmount } from './parsing/parsePolishAmount.ts'
import { getMonthFromDate } from './parsing/getMonthFromDate.ts'
import { formatPolishNumber } from './parsing/formatPolishNumber.ts'
import { processCSV } from './parsing/processCSV.ts'
import { classifyTransaction } from './parsing/classifyTransaction.ts'
